...
//length of array represents the number of chapters in book, each element of array at index i represents
//the number of verses in chapter i + 1 of that book.
books ={'Genesis': [31, 25, 24, 26, 32, 22, 24, 22, 29, 32, 32, 20, 18, 24, 21, 16, 27, 33, 38, 18, 34, 24, 20, 67, 34, 35, 46, 22, 35, 43, 54, 33, 20, 31, 29, 43, 36, 30, 23, 23, 57, 38, 34, 34, 28, 34, 31, 22, 33, 26],
...
$('#book-dd').change(function(){
    book = document.getElementById('book-dd').value;
    chapterdd = document.getElementById('chapter-dd');

    chapterdd.options.length = 0;
    for(i = 0; i < books[book].length; i++){
        var opt = document.createElement("option");
        opt.value = i+1;
        opt.text = i+1;
        chapterdd.options.add(opt);
    }
    ...
    for(i = 0; i < books[book][chapter-1]; i++){
        ...
        versedd.options.add(opt);

    }

});

$('#chapter-dd').change(function(){
    book = document.getElementById('book-dd').value;
    chapter = document.getElementById('chapter-dd').value;
    versedd = document.getElementById('verse-dd');
...
$(document).on('click', "#submit", function(e){
    ...
    var book = document.getElementById('book-dd').value;
    $('#book').val(book);
